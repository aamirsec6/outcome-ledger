  ...
  if (status === "done") {
    return (
      <div className="py-8 text-center">
        ...
        {spots > 0 && (
          <p className="mt-4 text-sm text-emerald-400/90">{spots} spots left in this cohort.</p>
        )}
      </div>
    );
  }
  ...
  return (
    <>
      ...
      <form className={cn("space-y-4", !compact && "mt-6")} onSubmit={onSubmit}>
        ...
        <div>
          <label className="text-xs font-medium text-zinc-500">Work email *</label>
          <input
            type="email"
            required
            value={email}
            ...
            className="mt-1.5 w-full rounded-xl border border-[var(--border)] bg-[var(--bg)] px-4 py-3 text-sm text-white outline-none transition focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/30"
          />
        </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  className="mt-1.5 w-full rounded-xl border border-[var(--border)] bg-[var(--bg)] px-4 py-3 text-sm text-white outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/30"
                />
              </div>
              <div>
              ...
              <label
                ...
                className={cn(
                  ...
                  solutions.includes(opt.id)
                    ...
                    : "border-[var(--border)] bg-[var(--bg)] text-zinc-400 hover:border-zinc-600"
                )}
              >
                <input
                  type="checkbox"
                  ...
                  className="mt-1 rounded border-zinc-600 accent-emerald-500"
                />
        ...
        {!compact && (
          <div>
            <label className="text-xs font-medium text-zinc-500">Anything else?</label>
            <textarea
              value={otherSolution}
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-full bg-white px-4 py-3.5 text-sm font-semibold text-zinc-950 transition hover:bg-zinc-100 disabled:opacity-60"
        >
